...
;; org-static-blog
;; https://github.com/bastibe/org-static-blog#examples
;; https://github.com/alhassy/alhassy.github.io/blob/master/AlBasmala.el
...
(setq org-static-blog-page-preamble
      "<div class=\"header\">
  <a href=\"https://alienzj.github.io/\" class=\"logo\">Hello World</a>
  <br>
    <a href=\"https://alienzj.github.io/Hello\">Hello</a>
...
(cl-defun zj/org-static-blog-assemble-image (file)
...
followed by the HTML code for comments."
  ...
  (let ((org-hide-block-startup nil))
    (with-temp-buffer
      ...
      ;; (insert "\n#+HTML_HEAD: <link href=\"../styles/doom-solarized-light.css\" rel=\"stylesheet\">\n")
      (org-mode)
      (outline-show-all)
      (switch-to-buffer (htmlize-buffer))
      (write-file (concat "~/documents/doraemon/org/blog/alienzj.github.io/" (f-base post-filename) ".org.html"))
      (kill-buffer)))
  ...
  (concat
   ...
   "&emsp;"
   "<a href=\"https://github.com/alienzj/alienzj.github.io/commits/master/"
   "posts/" (f-base post-filename) ".org\"><img
   src=\"https://img.shields.io/badge/-History-informational?logo=github\"></a>"
   "<br>"
   "<a href=\"https://www.buymeacoffee.com/alienzj\"><img src="
  ...
  (let (file desc)
    ...
    (insert "#+title: " (read-string "Title: ")
            ...
            "\n#+fileimage: " (completing-read
                               "Image: "
                               (mapcar #'f-filename (f-entries "~/documents/doraemon/org/blog/alienzj.github.io/images/")))
...
"
             ...
             (pcase (or (car prefix) 0)
               ...
               (16 ;; (org-static-blog-publish t) ⇒ Crashes.
                ...
                (thread-last (f-entries "~/documents/doraemon/org/blog/alienzj.github.io/")
